...
LOG_FILE = PROJECT_ROOT / "concalls.log"
SEEN_FILE = PROJECT_ROOT / "concalls_seen.json"          # dedup: filing_key -> date
SUMMARY_DIR = PROJECT_ROOT / "concalls_cache"            # one .json per filing
LOG_FILE_HISTORY = PROJECT_ROOT / "concalls_log.json"    # alert send history
